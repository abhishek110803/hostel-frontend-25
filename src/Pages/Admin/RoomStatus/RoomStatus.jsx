function RoomStatus({ newSelectedRoom, hostelName }) {
    ...
    return (
        ...
        <>
            ...
            <div className="w-full h-12 z-1 bg-zinc-50 sticky top-36 md:top-40 pt-2 mb-20">
                <div className=" w-[98%]   ml-auto mr-auto bg-slate-600 flex flex-col justify-around p-1 rounded-xl text-zinc-50 md:flex-row ">
                    ...
                    <div className="flex   justify-around items-center w-[98%]   md:w-[60%]  h-[70px]  md:h-[70px] rounded-xl   font-normal text-sm">
                        ...
                        <div className="flex flex-col h-[70px] md:h-[70px] justify-around items-center  ">
                            <div className=" w-6 h-6 md:w-8 mb-1 md:h-8  rounded-md  bg-zinc-500  border border-zinc-50">


                            </div>
                            <h1 className="text-center md:hidden"> Vacant</h1>
                            <h1 className="text-center hidden md:contents"> Vacant</h1>
                        </div>
                        ...
                        <div className="flex flex-col h-[70px] md:h-[70px] justify-around items-center  ">
                            ...
                            <h1 className="text-center"> Blocked </h1>
                        </div>
