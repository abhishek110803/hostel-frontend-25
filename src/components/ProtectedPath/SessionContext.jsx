...
export const SessionProvider = ({ children }) => {
    ...
    useEffect(() => {
        ...
        const matchedStep = stepsArray.find(step => step.stepNumber === session.step);

        if (matchedStep) {
            if (allowedPaths.includes(location.pathname)) {
                if (location.pathname !== matchedStep.href) {
    ...
    return (
        <SessionContext.Provider value={{ session, setSession, updateSession, logout }}>
            {children}
