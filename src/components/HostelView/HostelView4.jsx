...
const HostelView3 = ({ floor,  hname, roomsDetails, newSelectedRoom, changeSelectedRoom }) => {
    ...
    useEffect(() => {
        ...
        const updateRoomDetails = (type, rooms) => {
            ////console.log('main hun room details', rooms);
    ...
    return (<>
        ...
        <div className="md:w-[98%] flex flex-col justify-center items-center bg-green-800 ml-auto mr-auto  rounded-b-2xl  overflow-scroll ">
            ...
            <div className="flex  flex-col justify-around items-start  w-[870px] h-[505px]  rounded-t-none rounded-b-xl m-auto bg-zinc-500  ">

                <div className="flex  justify-around items-start  w-[870px] h-[425px]  rounded-t-none rounded-b-xl m-auto bg-zinc-500 ">
                    ...
                    <div className="flex  flex-col justify-between items-center w-[710px] h-[425px] rounded-t-none rounded-b-xl bg-yellow-50 ">



                        <div className="  flex  flex-col items-start w-[660px] h-[400px] bg-zinc-500  rounded-t-none rounded-b-xl  ">
                            <div className="  flex  fl items-start w-[660px] h-[340px] bg-zinc-500  rounded-t-none rounded-b-xl  ">
                                ...
                                <div className="  flex ml-auto justify-center items-start w-[500px] h-[320px] bg-green-800  rounded-t-none rounded-b-xl  ">
                            ...
                            <div className="  flex   items-center w-[660px] h-[80px] bg-zinc-500  rounded-t-none rounded-b-xl  ">
                                ...
                                <div className="  flex ml-auto justify-around items-center w-[500px] h-[50px] bg-zinc-50   rounded-xl  ">
                                    {/* mi */}
                ...
                <div className="flex  justify-around items-center  w-[870px] h-[80px]  rounded-t-none rounded-b-xl m-auto bg-zinc-500">
                    ...
                    <div className="flex   justify-around items-center w-[710px] h-[50px] rounded-xl bg-zinc-50 ">
                        {/* mo */}
