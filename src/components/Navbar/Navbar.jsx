...
function NavBar() {
  ...
  const Schedule_url =
    "https://drive.google.com/file/d/12XixvATiUnumOCUZWmOI-mZJdRRXcvpA/view";
  const Steps_url =
    "https://drive.google.com/file/d/1RgQ0_VkJnNoLC6xXO8AIE-yUc_1BESZF/view";
  const Hostel_Availability_url =
    "https://drive.google.com/file/d/12zPFHhPt8EhglLDLQVNKTX-ufiErMBIa/view";
      ...
      <Container fluid className="relative">
        ...
        <div className="hidden md:flex ml-auto items-center">
          <Link
            ...
            className="btn bg-blue-100 btn-outline-primary mx-1"
          >
          ...
          <Link
            onClick={() => downloadFileAtURL(Schedule_url)}
            className="btn bg-blue-100 btn-outline-primary mx-1"
          >
            <Download className="h-5 w-5 inline-block -mt-1 mr-1" />
            Schedule
          ...
          {!session && (
            <>
              <Link
                to="/SignIn"
                className="btn  bg-blue-700 text-white btn-outline-primary mx-1"
              >
